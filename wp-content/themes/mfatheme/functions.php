...
function mfa_scripts_styles() {
    ...
    wp_enqueue_style('aos-css', 'https://unpkg.com/aos@2.3.1/dist/aos.css', array(), '2.3.1'); // Agrega la línea para AOS
    wp_enqueue_style('style', get_stylesheet_uri(), array('normalize', 'swiper-css', 'aos-css'), '1.0.0');
    ...
    wp_enqueue_script('aos-js', 'https://unpkg.com/aos@2.3.1/dist/aos.js', array('jquery'), '2.3.1', true); // Corrige el cuarto parámetro
    wp_enqueue_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('swiper-js', 'flowbite-js', 'aos-js'), '1.0.0');
}
